...
namespace Ksu.Cis300.PriorityQueueLibrary
{
    ...
    {
        /// <summary>
        /// Property to get Priority stored in root
        /// </summary>
        ...
        public static LeftistTree<KeyValuePair<TPriority, TValue>> Merge(LeftistTree<KeyValuePair<TPriority, TValue>> h1, LeftistTree<KeyValuePair<TPriority, TValue>> h2)
        {
            ...
            int com = h1.Data.Key.CompareTo(h2.Data.Key);
            if (com < 0) //h1 < h2
            {
        ...
        /// <summary>
        /// Removes the min priority from _elements, and returns its value
        /// </summary>
        /// <returns>value of min priority of _elements</returns>
